...
<html lang="it">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top" style="background-color: rgba(0, 0, 0, 0.9);">
      <div class="container px-3">
        <a class="navbar-brand" href="../index.html">Memoriae Librorum</a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item fw-bold"><a class="btn btn-outline-light fw-bold m-1" href="registrati.php">Registrati <i class="bi bi-at"></i></a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <section style="margin-top: 3vh;">
        <div class="container container-50">
            <form method="POST" action="../php/login.php" class="form row g-3 needs-validation mt-5 mx-3" novalidate>
                <h2>Accedi</h2>
                <div class="col-12">
                ...
                <div class="col-12">
                  <button class="btn btn-primary fc-white text-uppercase fw-bold text-white w-100 p-2 mt-1" type="submit">Accedi</button>
                </div>
